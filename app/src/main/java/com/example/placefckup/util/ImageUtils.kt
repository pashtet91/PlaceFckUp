package com.example.placefckup.util
...
object ImageUtils {
    ...
    fun createUniqueImageFile(context: Context): File{
        ...
        val filename = "PlaceFckup_" + timeStamp + "_"
    ...
    @Throws(IOException::class)
    fun rotateImageIfRequired(context: Context, img: Bitmap,selectedImg: Uri)
            :Bitmap{
        val input: InputStream? = context.contentResolver.openInputStream(
            selectedImg
        )
        val path = selectedImg.path
